...
from lib.Enums import Validation, Configure
from lib.Downloader import Downloader
from lib.UnixCreator import UnixCreator
...
from lib.ExtractorLogger import LogLevel
import time
from datetime import datetime

from lib.RunnerHandlerCreator import RunnerHandlerCreator
...
class GeneralTab(QWidget):
    def __init__(self, main):
        ...
        try:
            ...
            self.widgetsConnection = [
                ...
                {
                    Configure.WIDGET: "cfg_mtimeEnabled",
                    Configure.KEY: "mtimeenabled",
                },
                {Configure.WIDGET: "cfg_retries", Configure.KEY: "runnerretries", Configure.VALIDATION: Validation.INTEGER},
            ...
            self.runnerHandlerCreator = RunnerHandlerCreator(self.main, self)
    ...
    def showOutputHandlerCreator(self):
        ...
        self.runnerHandlerCreator.setWindowState(Qt.WindowState.WindowNoState)
        self.runnerHandlerCreator.show()
        self.runnerHandlerCreator.raise_()
        self.runnerHandlerCreator.activateWindow()
