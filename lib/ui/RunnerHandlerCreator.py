...
class Ui_Creator(object):
    def setupUi(self, Creator):
        ...
        self.cfg_repeatedAction = QComboBox(self.widget_6)
        self.cfg_repeatedAction.setObjectName("cfg_repeatedAction")

        self.horizontalLayout_3.addWidget(self.cfg_repeatedAction)
        ...
        self.widget_13 = QWidget(self.box_action)
        ...
        self.horizontalLayout_11 = QHBoxLayout(self.box_event)
        ...
        self.horizontalLayout_11.addWidget(self.cfg_runEvent)
        ...
        self.horizontalLayout_14 = QHBoxLayout(self.box_mask)
        ...
        self.cfg_runnerMask = QComboBox(self.box_mask)
        self.cfg_runnerMask.setObjectName("cfg_runnerMask")

        self.horizontalLayout_14.addWidget(self.cfg_runnerMask)

        self.label_10 = QLabel(self.box_mask)
        ...
        self.cfg_mask.setMinimumSize(QSize(128, 0))

        self.horizontalLayout_14.addWidget(self.cfg_mask)
    ...
    def retranslateUi(self, Creator):
        ...
        # if QT_CONFIG(tooltip)
        self.cfg_messageOnLine.setToolTip(
            QCoreApplication.translate(
                "Creator",
                "<html><head/><body><p>Throw a message box everytime the text is seen</p><p>Replacement map:</p><p>{user} -&gt; Current user handle/name/id</p><p>{runner} -&gt; Current runner name</p><p>{extractor} -&gt; Current extractor name</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.cfg_messageOnAction.setToolTip(
            QCoreApplication.translate(
                "Creator",
                "<html><head/><body><p>Throw a message box with this text if an action has been taken</p><p>Replacement map:</p><p>{user} -&gt; Current user handle/name/id</p><p>{runner} -&gt; Current runner name</p><p>{extractor} -&gt; Current extractor name</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.cfg_action.setToolTip(QCoreApplication.translate("Creator", "Run this action after n times the text has been seen", None))
        # endif // QT_CONFIG(tooltip)
        self.label_12.setText(QCoreApplication.translate("Creator", " but if it's seen again", None))
        # if QT_CONFIG(tooltip)
        self.cfg_repeatedAction.setToolTip(
            QCoreApplication.translate(
                "Creator",
                "<html><head/><body><p>If the text is seen again n times in the next/current job run a different action (or not)</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.box_mask.setToolTip(
            QCoreApplication.translate(
                "Creator", "Define an event from those available that the extractor should run, leave it at None if you are unsure", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.box_mask.setTitle(QCoreApplication.translate("Creator", "Masks", None))
        self.label_9.setText(QCoreApplication.translate("Creator", "Consider when", None))
        # if QT_CONFIG(tooltip)
        self.cfg_runnerMask.setToolTip(
            QCoreApplication.translate(
                "Creator", "<html><head/><body><p>Ignore Entry if current runner doesn't match this</p></body></html>", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_10.setText(QCoreApplication.translate("Creator", "is", None))
        # if QT_CONFIG(tooltip)
        self.cfg_mask.setToolTip(
            QCoreApplication.translate(
                "Creator",
                "<html><head/><body><p>Ignore Entry if the current extractor's state/operation doesn't match the following Mask<br/>'running' always matches</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
