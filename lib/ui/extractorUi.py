...
class Ui_Extractor(object):
    def setupUi(self, Extractor):
        if not Extractor.objectName():
            Extractor.setObjectName(u"Extractor")
        Extractor.resize(602, 424)
        palette = QPalette()
        ...
        self.grpbox_tabconsole.setObjectName(u"grpbox_tabconsole")
        ...
        self.cfgui_consoleshowWHITE.setObjectName(u"cfgui_consoleshowWHITE")
        ...
        self.cfgui_consoleshowGREEN.setObjectName(u"cfgui_consoleshowGREEN")
        ...
        self.btn_skipJob.setObjectName(u"btn_skipJob")
        ...
        self.btn_StopRun.setObjectName(u"btn_StopRun")
        ...
        self.theLogPlace.setObjectName(u"theLogPlace")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 598, 363))
        ...
        self.grpbox_settings.setObjectName(u"grpbox_settings")
        ...
        self.grpbox_settings.setTitle(u"Extractor Settings")
        ...
        self.lbl_twitterdestination.setObjectName(u"lbl_twitterdestination")
        self.lbl_twitterdestination.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.cfgui_defaultpath.setObjectName(u"cfgui_defaultpath")
        ...
        self.btn_pathselect.setObjectName(u"btn_pathselect")
        ...
        self.cfgui_sleeptime.setObjectName(u"cfgui_sleeptime")
        ...
        self.btn_copyLastCursor.setObjectName(u"btn_copyLastCursor")
        ...
        self.btn_deleteExtractor.setObjectName(u"btn_deleteExtractor")
    ...
    def retranslateUi(self, Extractor):
        Extractor.setWindowTitle(QCoreApplication.translate("Extractor", u"Form", None))
        self.grpbox_tabconsole.setTitle(QCoreApplication.translate("Extractor", u"Console Settings", None))
        self.cfgui_consoleshowWHITE.setText(QCoreApplication.translate("Extractor", u"Infos", None))
        self.cfgui_consoleshowYELLOW.setText(QCoreApplication.translate("Extractor", u"Alerts", None))
        self.cfgui_consoleshowRED.setText(QCoreApplication.translate("Extractor", u"Errors", None))
        self.cfgui_consoleshowGREY.setText(QCoreApplication.translate("Extractor", u"Debug", None))
        self.cfgui_consoleshowOTHER.setText(QCoreApplication.translate("Extractor", u"Api", None))
        self.cfgui_consoleshowGREEN.setText(QCoreApplication.translate("Extractor", u"Files", None))
        self.btn_skipJob.setText(QCoreApplication.translate("Extractor", u"Skip", None))
        self.btn_StopRun.setText(QCoreApplication.translate("Extractor", u"Run", None))
        self.btn_customRun.setText(QCoreApplication.translate("Extractor", u"Custom run", None))
        self.btn_showUsersTable.setText(QCoreApplication.translate("Extractor", u"Users", None))
        self.btn_showCookiesTable.setText(QCoreApplication.translate("Extractor", u"Cookies", None))
        self.btn_showErrored.setText(QCoreApplication.translate("Extractor", u"Errored", None))
        self.theLogPlace.setDocumentTitle("")
        self.theLogPlace.setPlaceholderText(QCoreApplication.translate("Extractor", u"Extractor's logs will be shown here", None))
        self.label_2.setText(QCoreApplication.translate("Extractor", u"Current selected cookies: None", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab1), QCoreApplication.translate("Extractor", u"Console", None))
        self.lbl_twitterdestination.setText(QCoreApplication.translate("Extractor", u"Default destination", None))
#if QT_CONFIG(tooltip)
        self.cfgui_defaultpath.setToolTip(QCoreApplication.translate("Extractor", u"<html><head/><body><p>The extraction path of users with text 'default' as destination will go in (folder is named with the username). </p><p>Useful for archiving many accounts to the same folder</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.cfgui_defaultpath.setText("")
        self.cfgui_defaultpath.setPlaceholderText(QCoreApplication.translate("Extractor", u"Absolute Path", None))
        self.btn_pathselect.setText(QCoreApplication.translate("Extractor", u"...", None))
        self.lbl_sleep.setText(QCoreApplication.translate("Extractor", u"Sleep", None))
        self.cfgui_sleeptime.setText("")
        self.cfgui_sleeptime.setPlaceholderText(QCoreApplication.translate("Extractor", u"Integer (Seconds)", None))
        self.label.setText(QCoreApplication.translate("Extractor", u"Settings are applied on extractor restart", None))
        self.btn_copyLastCursor.setText(QCoreApplication.translate("Extractor", u"Copy last cursor", None))
        self.btn_deleteExtractor.setText(QCoreApplication.translate("Extractor", u"Delete extractor", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab2), QCoreApplication.translate("Extractor", u"Settings", None))
    # retranslateUi
